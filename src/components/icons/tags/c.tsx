...
export const CIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    // The exact viewBox is kept to ensure the icon's proportions are correct.
    viewBox="32.18585611720149 20.47 223.6851360941233 247.05999999999997"
    xmlns="http://www.w3.org/2000/svg"
    // Hard-coded width and height have been removed to allow for CSS sizing.
  >
    {/* The original hard-coded fill colors are preserved for this multi-color logo. */}
    <path
